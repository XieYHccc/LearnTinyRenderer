...
struct DepthShader : public IShader {
    ...
    mat<4, 4, float> uniform_model;             // Projection*ModelView
    mat<4, 4, float> uniform_lightSpaceMatrix;
...
int main(int argc, char** argv) {
    ...
    TGAImage shadow_buffer(width, height, TGAImage::RGBA);
    ...
    { // rendering the shadow buffer
        ...
        mat4 Projection = perspective(45, width / height, 0.1, 10);
